...
m.train(
    ...
    project='runs/cargodefect', name='cargodefect_detect_defectw2_cls075', exist_ok=True,
    ...
    box=7.5, cls=0.75, dfl=1.5, class_weights=[1.0, 2.0],
)
print('cargodefect_detect_defectw2_cls075 DONE')
" > runs/cargodefect/train_defectw2_cls075.log 2>&1
