#!/bin/bash
# Train YOLOv26 baseline — PACKAGE + DEFECT (nc=2)
# Standard Detect head, no CargoInspectionHead
# NO full-image pseudo bbox — uses clean labels from regenerated dataset
set -e
cd "$(dirname "$0")/.."
...
print('package_defect_baseline DONE')
"
